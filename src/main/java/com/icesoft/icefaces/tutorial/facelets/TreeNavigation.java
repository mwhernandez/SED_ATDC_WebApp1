 ...
 * Modificado Por : Eli Diaz Horna  -----  25-10-2021 ---MENU DE REMITENTES BPM
 * Modificado Por : Eli Diaz Horna  -----  12-09-2023 ---MENU DE INGRESO DE DOCUMENTOS POR MESA DE PARTES
 */
        ...
        if (rootTreeNode != null) {
            ...
            if (navigationObject != null &&
             ...
             // Sub Nodo de Ingreso Documentos Entrantes Grupo Areas
                ...
                branchObject.setLeaf(true);  
                if (ncodperfil == 6 || ncodperfil == 16 || ncodperfil == 15){                
             ...
             // Sub Nodo de Ingreso Documentos Entrantes Grupo Areas
               ...
               // branchObject.setMenuContentInclusionFile("./content/DE/doc_entrante_gerencias.jspx");
                ...
                branchObject.setNavigationSelection(navigationBean);
                if (ncodperfil ==4 || ncodperfil==13 || ncodperfil==14){
	                branchObject.setPageContent(false);
	                branchNode = new DefaultMutableTreeNode(branchObject);
	                branchObject.setWrapper(branchNode);
	                // finally add the new custom component branch
             ...
             // Sub Nodo de Mesa Partes
              ...
              //nuevo menu Ingreso de Documentos 12.09.2023 EDH
                // Sub Nodo de Mesa Partes
                   branchObject = new PageContentBean();
                   branchObject.setMenuDisplayText("Bandeja Mesa Partes Ingreso");
                   //branchObject.setMenuContentTitle("Seguimento Documentos");
                   branchObject.setMenuContentInclusionFile("./content/DE/doc_entrante_mesa_ingreso.jspx");
                   branchObject.setTemplateName("ingresodocMPContentPanel");
                   branchObject.setNavigationSelection(navigationBean);
                   if (ncodperfil ==14){
   	                leafNode = new DefaultMutableTreeNode(branchObject);
                ...
                branchObject = new PageContentBean();
                branchObject.setMenuDisplayText("Bandeja Linea Digitalización");
                //branchObject.setMenuContentTitle("Seguimento Documentos");
                ...
                leafNode = new DefaultMutableTreeNode(branchObject);
                branchObject.setWrapper(leafNode);
                if (ncodperfil==1||ncodperfil==2||ncodperfil==6||ncodperfil==7||ncodperfil==10 ||ncodperfil==8 ||ncodperfil==15){
                		if (ncodperfil !=5){
                		branchObject.setLeaf(true);
                		branchNode.add(leafNode);                	
                		}    	
				 ...
				 * branchObject.setMenuDisplayText("Bandeja Doc.Salientes");
				 * //branchObject.setMenuContentTitle("Registro Documentos Salientes");
				 * branchObject.setMenuContentInclusionFile(
				 * "./content/DS/DocumentoSalidaDerivado.jspx");
				 * branchObject.setTemplateName("salienteContentPanelconsulta");
				 * branchObject.setNavigationSelection(navigationBean); leafNode = new
				 * DefaultMutableTreeNode(branchObject); branchObject.setWrapper(leafNode); if
				 * (ncodperfil==8){ branchObject.setLeaf(true); branchNode.add(leafNode); }
				 */
             ...
             // Nodo de Mantenimiento
                ...
                // Sub nodo de remitentes BPM
                branchObject = new PageContentBean();
                branchObject.setMenuDisplayText("Remitentes BPM");
                //branchObject.setMenuContentTitle("Tipo Documentos");
                branchObject.setMenuContentInclusionFile("./content/MAN/remitente_bmp.jspx");
                branchObject.setTemplateName("remitentebpmContentPanel");
                branchObject.setNavigationSelection(navigationBean);
                if (ncodperfil!=13){
	                if (ncodperfil!=7){
		                if (ncodperfil!=8){
             ...
             // Sub nodo de consultas informes estadisticos
                ...
                branchObject.setNavigationSelection(navigationBean);
                if (ncodperfil ==1 || ncodperfil == 4 || ncodperfil == 13 || ncodperfil == 14) { 
	                leafNode = new DefaultMutableTreeNode(branchObject);
	                branchObject.setWrapper(leafNode);
	                branchObject.setLeaf(true);
	                // finally add the new custom component branch
             ...
             // Sub nodo de consultas de documentos de entrada
                ...
                //branchObject.setMenuContentTitle("áreas");
             ...
             // Nodo de Administracion
                ...
                //branchObject.setMenuContentTitle("Administración");
                ...
                //branchObject.setMenuContentTitle("Información");
