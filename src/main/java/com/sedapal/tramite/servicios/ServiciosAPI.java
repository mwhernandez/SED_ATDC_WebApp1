	...
	public String enviarNotificacionBPM2(CasillaElectronicaResponse ce) {
		...
		ruta=credencialesApiDao.getRuta(5);
		 ...
		 String parametro1 = jsonDocumentoRequest; // Aquí se define el valor del parámetro
	        ...
	        //httpPost.setHeader(HttpHeaders.AUTHORIZATION, "Bearer "+token); comenta Eli Diaz 
	        httpPost.setHeader(HttpHeaders.AUTHORIZATION, "Basic "+token);
	        httpPost.setHeader("esigna-auth-api-key", credenciales.getKey());
	        System.setProperty("https.protocols", "TLSv1");
	        
	        System.out.println("Estoy viendo los parametros de notificacion");
	        //System.out.println("AUTHORIZATION" + token);
	        System.out.println("esigna-auth-api-key" + credenciales.getKey());
