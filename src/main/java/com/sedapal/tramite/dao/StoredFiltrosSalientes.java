...
public class StoredFiltrosSalientes extends StoredProcedure implements RowMapper {
	...
	private static final String SPROC_NAME = "ATDC_FILTRO_SALIENTE_V2";
	...
	private static final String FICHA_VISADOR = "v_ficha_visador";
	...
	public StoredFiltrosSalientes(DataSource dataSource) {
		...
		declareParameter(new SqlParameter(FICHA_VISADOR, OracleTypes.NUMBER));
	...
	public Map execute(String fecha1, String fecha2, String opcion, String area, String vtipo, String areaseleccionado,
			String estadoSeleccionado, int fichaVisador) {
		System.out.println("ATDC_FILTRO_SALIENTE_V2");
		System.out.println("Execute Stored..." + fecha1 + "   " + fecha2 + "  " + opcion + "  " + area + " " + vtipo
				+ " " + areaseleccionado + " " + estadoSeleccionado);
		...
		inputs.put(ESTADO, estadoSeleccionado);
		inputs.put(FICHA_VISADOR, fichaVisador);
