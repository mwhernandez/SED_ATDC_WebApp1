...
public class StoredVisadoDocumentoSalida extends StoredProcedure {
	private static final String SPROC_NAME = "ATDC_VISADO_DOCUMENTO_SALIENTE";
	...
	public StoredVisadoDocumentoSalida() {
	}

	public StoredVisadoDocumentoSalida(DataSource dataSource) {
