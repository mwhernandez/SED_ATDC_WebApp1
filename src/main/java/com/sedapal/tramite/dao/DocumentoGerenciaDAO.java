...
public class DocumentoGerenciaDAO implements IDocumentoGerenciaDAO{
	
	private JdbcTemplate jdbcTemplate;		
	private static Logger logger = Logger.getLogger("R1");	
	
	private StoredBusquedaDocumentoGerencia storedbusquedadocumentogerencia;
	...
	public List<ReporteGerencialBean> BusquedaDocumentoGerencia(int area, String fechaInicial, String fechaFinal) {
		Map output = storedbusquedadocumentogerencia.execute(area, fechaInicial, fechaFinal);
		List gerencial = (ArrayList)output.get("documentogerencia");
	...
	public void setStoredbusquedadocumentogerencia(
			StoredBusquedaDocumentoGerencia storedbusquedadocumentogerencia) {
		this.storedbusquedadocumentogerencia = storedbusquedadocumentogerencia;
	}
