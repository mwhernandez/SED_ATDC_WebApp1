...
public class StoredConsultaEntrantesMesaVirtual extends StoredProcedure implements RowMapper {

	private static final String SPROC_NAME = "ATDC_CONSULTA_ENTRAN_MESA_VIRTUAL";
	...
	public StoredConsultaEntrantesMesaVirtual() {
		// TODO Auto-generated constructor stub
	}

	public StoredConsultaEntrantesMesaVirtual(DataSource dataSource) {
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        bean.setTipoingreso(rs.getString("TIPOINGRESODETALLE"));
        bean.setMotivoingreso(rs.getString("MOTIVOINGRESODETALLE"));
