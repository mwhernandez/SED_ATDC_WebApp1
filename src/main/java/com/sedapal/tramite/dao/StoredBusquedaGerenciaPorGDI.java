...
public class StoredBusquedaGerenciaPorGDI extends StoredProcedure implements RowMapper {

	private static final String SPROC_NAME = "ATDC_RPTE_GERENCIAL_GDI";	
	...
	public StoredBusquedaGerenciaPorGDI() {
		// TODO Auto-generated constructor stub
	}

	public StoredBusquedaGerenciaPorGDI(DataSource dataSource) {
		...
		declareParameter(new SqlOutParameter("reportegerencialgdi",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
		ReporteGerencialBean bean = new ReporteGerencialBean();       
	        ...
	        bean.setDerivacion(rs.getString("DERIVACION"));
