...
public class StoredFiltrosEntDerivado extends StoredProcedure implements RowMapper {

	private static final String SPROC_NAME = "S_GUIA.ATDC_FILTRO_ENTRANTE_DERIVADO";
	...
	public StoredFiltrosEntDerivado() {
		// TODO Auto-generated constructor stub
	}

	public StoredFiltrosEntDerivado(DataSource dataSource) {
	...
	public Map execute(String fecha1, String fecha2, String tipos, String area, int ficha) {
		System.out.println("Execute Stored..."+ fecha1+"   "+ fecha2 +"  "+tipos +"  "+ area + " "+ficha);
