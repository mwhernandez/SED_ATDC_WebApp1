...
public class StoredEntrantes extends StoredProcedure implements RowMapper {
	
	private static final String SPROC_NAME = "S_GUIA.ATDC_DOC_ENTRAN_ALL"; 
	//private static final String SPROC_NAME = "ATDC_PKG_DOCUMENTO_ENTRANTE.ATDC_DOC_ENTRAN_ALL";	
	private static final String NCODAREA = "v_codarea";

		
	public StoredEntrantes() {
		// TODO Auto-generated constructor stub
	}

	public StoredEntrantes(DataSource dataSource) {
		super(dataSource, SPROC_NAME);		
		declareParameter(new SqlParameter(NCODAREA, Types.VARCHAR));
		declareParameter(new SqlOutParameter("entrantes",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
	      ...
	      //cambio 07/09/2022 EDH
	        ...
	        bean.setDhoralinea(rs.getTime("FECHA_LINEA"));
	        //SED-FIN-161 FIN
		return bean;
	}
}