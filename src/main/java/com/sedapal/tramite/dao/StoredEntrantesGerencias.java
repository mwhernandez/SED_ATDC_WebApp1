...
public class StoredEntrantesGerencias extends StoredProcedure implements RowMapper {
	
	private static final String SPROC_NAME = "ATDC_DOC_ENTRAN_GERENTES";	
	...
	public StoredEntrantesGerencias() {
		// TODO Auto-generated constructor stub
	}

	public StoredEntrantesGerencias(DataSource dataSource) {
		super(dataSource, SPROC_NAME);		
		declareParameter(new SqlParameter(NCODAREA, Types.VARCHAR));
		declareParameter(new SqlOutParameter("gerencias",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
