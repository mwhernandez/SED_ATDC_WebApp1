...
public class EntranteMesaDAO implements IEntranteMesaDAO{

	private JdbcTemplate jdbcTemplate;
    private StoredEntrantesMesa storedEntrantesmesa;   
    ...
    private StoredBusquedaEntrantesMesa storedbusquedaentrantemesa;
	...
	public List<EntranteMesaBean> entrantesSP(String ncodarea) {
		...
		Map output = storedEntrantesmesa.execute(ncodarea);    	
 ...
 public List<AnioBean> anio(){    		
	...
	public void setStoredEntrantesmesa(StoredEntrantesMesa storedEntrantesmesa) {
		this.storedEntrantesmesa = storedEntrantesmesa;
	}
	...
	public List<EntranteMesaBean> BusquedaSP(String area, String opcion, String detalle) {
		...
		Map output = storedbusquedaentrantemesa.execute(area, opcion, detalle);
		nowOut = System.currentTimeMillis();
		nowDif = nowOut - nowIn;
	...
	public void setStoredbusquedaentrantemesa( StoredBusquedaEntrantesMesa storedbusquedaentrantemesa) {
		this.storedbusquedaentrantemesa = storedbusquedaentrantemesa;
	}
