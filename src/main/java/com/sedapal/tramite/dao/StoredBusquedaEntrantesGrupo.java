...
public class StoredBusquedaEntrantesGrupo extends StoredProcedure implements RowMapper {

	private static final String SPROC_NAME = "S_GUIA.ATDC_BUSQUEDA_DOC_ENT_GRUPO";	
	...
	public StoredBusquedaEntrantesGrupo() {
		// TODO Auto-generated constructor stub
	}

	public StoredBusquedaEntrantesGrupo(DataSource dataSource) {
		...
		declareParameter(new SqlOutParameter("busquedas_entrantes_grupo",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
