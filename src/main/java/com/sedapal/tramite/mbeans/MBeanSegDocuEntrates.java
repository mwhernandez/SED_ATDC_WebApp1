...
public class MBeanSegDocuEntrates implements IMBeanSegDocuEntrantes, Serializable {
    ...
    //para anexos
  	...
  	private boolean verAdjuntosAnexos;
    ...
    public void resetAnexos() {
    	verPdf2 = false;
    	lsAnexos = new ArrayList<Anexo>();
        ...
        try {
            ...
            if (valida.equals("ok")) {
                ...
                */	
                ...
                for (String palabra : palabras) {
                    if (cadenaDondeBuscar.contains(palabra)) {
                        ...
                        //aquó tu lógica en caso que se haya encontrado...
                ...
                */
                ...
                //OJO se esta pasando un parómetro mós areasFichas			
			/*for(Seguir p:this.seleccionados)
                 {
                 ...
                 //Aqui se debe considerar insertar mós de un derivado o actualizarlo, ahora son varios areas y fichas
                 if (verifica==0){
                 ...
                 //Aqui se debe considerar mós de un derivado nuevo
    ...
    public void rowSelectionListener(RowSelectorEvent event) {
        ...
        this.verPdf2 = false;
        if (!selectedSeguimientoss.isEmpty()) {
        	lsAnexos = obtenerAnexos((int) selectedSeguimientoss.get(0).getCorrelativo(), selectedSeguimientoss.get(0).getComentario(), selectedSeguimientoss.get(0).getNumdoc(), selectedSeguimientoss.get(0).getAno());	
    ...
    public void captura_origen(ValueChangeEvent changeEvent) {
        ...
        if (origenes==1) {
            ...
            List<AreaBean> areas = seguimientodocumentoDAO.areas_salida();
            List itemsAreas = Utils.getAreas(areas);
            // this.items7a = Utils.getAreasLink(areas);
            this.items1 = itemsAreas;
        } else {
            System.out.println("Externo");
            List<RemitenteBean> remitente = seguimientodocumentoDAO.remitentes_salida();
