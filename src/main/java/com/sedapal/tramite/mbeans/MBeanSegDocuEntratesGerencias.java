        ...
        try {
            ...
            if (valida.equals("ok")) {
				...
				/*for(Seguir p:this.seleccionados)
                     ...
                     //Aqui se debe considerar insertar más de un derivado o actualizarlo, ahora son varios areas y fichas
                     if (verifica==0){
                     ...
                     //Aqui se debe considerar más de un derivado nuevo
    ...
    public void eventCopiarSeguimiento(ActionEvent event) {
        ...
        try {
            ...
            if (valida.equals("ok")) {
                ...
                //OJO se esta pasando un parámetro más areasFichas			
			/*for(Seguir p:this.seleccionados)
                 {
                 //Ahora son varias Areas !!!
                 seguimientoBean.setAreaderivado(Integer.parseInt(p.getCodArea()));
