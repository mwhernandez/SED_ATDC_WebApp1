...
public class MBeanEntrantes extends BaseSortableList implements IMBeanEntrantes, Serializable {
    ...
    // private String mensaje = "Transacci�n no Valida";
    ...
    //añadimos el numero parametro 29.05.2023 EDH
...
//                     this.items3 = itemsTrabajador;
    ...
    */
    ...
    public void posterior() {
      ...
      //SED-FON-161
        List<TiposDocumentosBean> listTipoDoc = entranteDAO.getTiposDocumentos();
        TiposDocumentosBean tdnombre = new TiposDocumentosBean();
        tdnombre.setCodigo("DOC0000");
        tdnombre.setDescripcion("NOMBRE");
        listTipoDoc.add(tdnombre);
        List itemsTD= Utils.getTipos_Documentos(listTipoDoc);
