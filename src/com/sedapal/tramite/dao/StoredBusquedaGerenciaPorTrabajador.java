...
public class StoredBusquedaGerenciaPorTrabajador extends StoredProcedure implements RowMapper {
	...
	private static final String FICHA = "n_ficha";
	

	
		
	public StoredBusquedaGerenciaPorTrabajador() {
		// TODO Auto-generated constructor stub
	}

	public StoredBusquedaGerenciaPorTrabajador(DataSource dataSource) {
		...
		declareParameter(new SqlParameter(FICHA, Types.NUMERIC));
		declareParameter(new SqlOutParameter("reportegerenciaportrabajador",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}

	public Map execute(int area, String fechainicial, String fechafin, int ficha) {
