...
public class StoredActualizarAsunto extends StoredProcedure{
	private static final String SPROC_NAME = "ATDC_UPDATE_ASUNTO";	
	...
	public StoredActualizarAsunto() {
		// TODO Auto-generated constructor stub
	}

	public StoredActualizarAsunto(DataSource dataSource) {
	...
	public Map execute(TiposBean tiposBean) {
		...
		inputs.put(NCODIGO, tiposBean.getTipo());
