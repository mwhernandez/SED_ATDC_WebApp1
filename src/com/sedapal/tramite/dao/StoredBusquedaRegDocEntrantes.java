...
public class StoredBusquedaRegDocEntrantes extends StoredProcedure implements RowMapper {

	private static final String SPROC_NAME = "ATDC_BUSQUEDA_REG_DOC_ENT";
	private static final String REGISTRO = "v_registro";
	...
	public StoredBusquedaRegDocEntrantes() {
		// TODO Auto-generated constructor stub
	}

	public StoredBusquedaRegDocEntrantes(DataSource dataSource) {
		...
		declareParameter(new SqlOutParameter("consulta_registro",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        //bean.setVresrecepcion(rs.getString(""));
        //bean.setDfecharecepcion(rs.getDate(""));
