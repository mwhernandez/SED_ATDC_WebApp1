...
public class StoredCentro extends StoredProcedure implements RowMapper {
	
	private static final String SPROC_NAME = "ATDC_CENTRO";
	...
	public StoredCentro(DataSource dataSource) {
