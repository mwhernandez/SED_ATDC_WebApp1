...
public class StoredEntrantesMesa extends StoredProcedure implements RowMapper {
	
	private static final String SPROC_NAME = "ATDC_DOC_ENTRAN_MESA";	
	//private static final String SPROC_NAME = "ATDC_PKG_DOCUMENTO_ENTRANTE.ATDC_DOC_ENTRAN_MESA";
	private static final String NCODAREA = "v_codarea";

		
	public StoredEntrantesMesa() {
		// TODO Auto-generated constructor stub
	}

	public StoredEntrantesMesa(DataSource dataSource) {
