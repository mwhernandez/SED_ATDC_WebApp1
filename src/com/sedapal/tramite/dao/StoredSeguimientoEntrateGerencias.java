...
public class StoredSeguimientoEntrateGerencias extends StoredProcedure implements RowMapper {
	
	//private static final String SPROC_NAME = "ATDC_DOC_SEG_GERENCIA";
	//04/12/2019
	private static final String SPROC_NAME = "ATDC_DOC_SEG_ALL";
	//private static final String SPROC_NAME = "ATDC_PKG_DOCUMENTO_ENTRANTE.ATDC_DOC_SEG_ALL";
	...
	public StoredSeguimientoEntrateGerencias() {
		// TODO Auto-generated constructor stub
	}

	
	public StoredSeguimientoEntrateGerencias(DataSource dataSource) {
