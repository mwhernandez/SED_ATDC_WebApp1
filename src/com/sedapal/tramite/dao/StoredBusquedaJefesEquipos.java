...
public class StoredBusquedaJefesEquipos extends StoredProcedure implements RowMapper {
	...
	public StoredBusquedaJefesEquipos() {
		// TODO Auto-generated constructor stub
	}

	public StoredBusquedaJefesEquipos(DataSource dataSource) {
		super(dataSource, SPROC_NAME);
		declareParameter(new SqlParameter(OPCION, Types.VARCHAR));
		declareParameter(new SqlParameter(DETALLE, Types.VARCHAR));		
		declareParameter(new SqlOutParameter("filtrostipos",OracleTypes.CURSOR, this));//cuenta_cursor?
		compile();
	}
