...
public class StoredResumenDocEntrantes extends StoredProcedure implements RowMapper {

    private static final String SPROC_NAME = "ATDC_PKG_REPORTES.ATDC_REPORTE_ESTADO_DOCS_AREA";
    ...
    public StoredResumenDocEntrantes() {
        // TODO Auto-generated constructor stub
    }

    public StoredResumenDocEntrantes(DataSource dataSource) {
    ...
    public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        beanEstDocEntr.setNomColumna(rs.getString("ESTADO"));
