...
public class StoredNuevoDocumentoSaliente extends StoredProcedure{
	private static final String SPROC_NAME = "ATDC_PKG_DOCUMENTO_SALIENTE.ATDC_NUEVO_DOCUMENTO_SALIENTE_BPM";	
	...
	public Map execute(DocumentoSalidaBean documentoSalidaBean) {
		...
		System.out.println("Manda los parametros para nuevo salida");
