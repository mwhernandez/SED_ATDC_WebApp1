...
public class StoredNuevoSecuencial extends StoredProcedure implements RowMapper {

    private static final String SPROC_NAME      = "ATDC_PKG_MAINT.ATDC_NUEVO_SECUENCIAL_AREA";
    ...
    public StoredNuevoSecuencial() {
        // TODO Auto-generated constructor stub
    }

    public StoredNuevoSecuencial(DataSource dataSource) {
    ...
    public Map execute(String codArea, String annio, String codTipDoc, String usuResponsable) {
        System.out.println("Execute Stored..."+ codArea + " " + annio + " " + codTipDoc + " " + usuResponsable);
